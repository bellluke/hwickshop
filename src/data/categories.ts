...
export const categories: Category[] = [
  ...
  { id: 'baby', name: '육아', emoji: '👶', description: '초보 부모를 위한 가이드', path: '/baby', color: 'var(--color-cat-baby)' },
  { id: 'school', name: '신학기', emoji: '🎒', description: '입학부터 졸업까지', path: '/school', color: 'var(--color-cat-school)' },
  { id: 'health', name: '건강', emoji: '💪', description: '건강한 시작을 위한 준비', path: '/health', color: 'var(--color-cat-health)' },
  { id: 'gift', name: '선물', emoji: '🎁', description: '마음을 전하는 선물 가이드', path: '/gift', color: 'var(--color-cat-gift)' },
  { id: 'sport', name: '운동 & 취미', emoji: '🚴', description: '새로운 취미를 시작해볼까', path: '/sport', color: 'var(--color-cat-sport)' },
];
